...
public partial class @PlayerInput: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInput()
    {
        ...
        UnityEngine.Debug.Assert(!m_ObjectControl.enabled, "This will cause a leak and performance issues, PlayerInput.ObjectControl.Disable() has not been called.");
    ...
    {
        private @PlayerInput m_Wrapper;
        public ObjectControlActions(@PlayerInput wrapper) { m_Wrapper = wrapper; }
